...
class MyViewModel: ViewModel() {
    ...
    val dogs = mutableListOf(
        Dog(2, "德国牧羊犬", "这是一条德国牧羊犬", "德国牧羊犬（德语：Deutscher Schäferhund；英语：German Shepherd），是狗的一个品种，1977年才正式确定命名为德国牧羊犬[1]，故各地命名迥异，中文语境下常称为德国狼犬[2]或德国狼狗。德国牧羊犬在所有犬类的智商排名中排行第三。[来源请求]它们敏捷且适合活动的工作环境，经常被部署各种任务，例如警察、护卫、搜索及拯援和军事，它们也为盲者做导盲犬的工作；因台湾在日治时期大量使用德国牧羊犬为军犬，所以德国牧羊犬在台湾使用的闽南语名称为“军用犬”。\n" +
                "\n" +
                ...
                "\n" +
                "目前常见的德国牧羊犬有经过进一步改良的“西德德牧”以及较为原始的“东德德牧”。两者体型有显著区别，“西德德牧”为加强其观赏性，因此背部背弓弧度较“东德德牧”大。通常比较常见的为“西德德牧”。", R.mipmap.dog_2, R.mipmap.dog_b_2),
        Dog(3, "斗牛犬", "这是一条斗牛犬", "斗牛犬（英语：Bulldog）系一种哺乳类动物，系一中型犬种，又名老虎狗、牛头犬，斗牛犬一词通常被用来称呼英国斗牛犬（English Bulldog 或 British Bulldog），其余斗牛犬种包含美国斗牛犬（American Bulldog）、古英国斗牛犬（Old English Bulldog）、勒维特斗牛犬（Leavitt Bulldog）、复刻版英国斗牛犬（Olde English Bulldogge）以及法国斗牛犬（French Bulldog）等。\n" +
                "\n" +
                "\n" +
                "勒维特斗牛犬\n" +
                "其中古英国斗牛犬因斗牛活动被禁止后已经灭绝；复刻版英国斗牛犬则系由育种者于近四十余年前起针对斗牛犬过多遗传疾病改良之品种，其外貌与古英国斗牛犬近似，然性情温和友善且健康状况远优于斗牛犬；而勒维特斗牛犬与复刻版英国斗牛犬皆属育种者大卫·勒维特（David Leavitt）之杰作，但他认为复刻版的后代中多数已经逐渐流失了他当初培育的品质，所以另外以自己的姓氏命名之，其血统组成包含1/2的英国斗牛犬、1/6的美国斗牛犬、1/6的比特犬（American Pit Bull Terrier）以及1/6的斗牛獒犬（Bullmastiff）。", R.mipmap.dog_3, R.mipmap.dog_b_3),
        Dog(4, "贵宾犬", "这是一条贵宾犬", "法国的长卷毛犬、匈牙利的水猎犬、葡萄牙水犬、爱尔兰水犬、西班牙猎犬，甚至马尔济斯犬，都有可能是贵宾犬的祖先。\n" +
        ...
        Dog(6, "哈士奇", "这是一条哈士奇", "西伯利亚哈士奇（俄语：Сибирский хаски，Sibirskiy haski，英语：Siberian husky）是一种原产于西伯利亚东部的工作犬，常见别名哈士奇。西伯利亚哈士奇体重介于25～55磅(16～27kg)之间，身高大约20～23.5英寸(51～60cm)，是一种中型犬。\n" +
                "\n" +
                "由于有着能在北极严寒环境中繁衍生息的能力，西伯利亚哈士奇是一种适应力很强的犬种。它们最早是由西伯利亚东部的楚科奇族部落居民饲养，用于狩猎驯鹿，拖曳雪橇或者照顾幼儿使孩子们远离寒冷。", R.mipmap.dog_6, R.mipmap.dog_b_6),
        ...
        Dog(10, "大丹犬", "这是一条大丹犬", "大丹犬（Great Dane）原产于德国，历史上曾用做猎犬、护卫犬、斗犬、使役犬等，因其性格温顺、外貌优美，现今的发展方向主要是家庭用犬 [1]  。\\n\" +\n" +
                "                \"该品种外貌高大、优美，体高与体长相当。公犬体高在76cm以上，母犬体高在71cm以上，被毛短而贴身，平滑而有光泽。毛色有淡黄褐色、虎纹色、黑色、蓝色、花色等几种 [1]  。", R.mipmap.dog_10, R.mipmap.dog_b_10),
